...
void carregarArquivo(ListaCircular* lista, char* criterio) {
    ...
    // Verifica se o critério é um dia da semana (mais de 1 caractere)
    ...
    while (fgets(linha, sizeof(linha), arquivo)) {
        ...
        if (eh_dia) {
            ...
            // Verifica o último dígito da placa
...
// ... existing code ...
    ...
    while (fgets(linha, sizeof(linha), arquivo)) {
        ...
        // Verifica se atende ao critério (dia da semana ou final da placa)
